...
export default function StockLedgerCompany2() {
  // filters UI state
  ...
  const exportPDF = () => {
    const doc = new jsPDF();
    doc.setFontSize(16);
    doc.text("Stock Ledger (Hydroworx)", 14, 18);
    ...
    doc.save("stock-ledger-company2.pdf");
  };
  ...
  return (
    <div>
      <Group justify="space-between" mb="md">
        <div>
          <Title order={2}>Stock Ledger (Hydroworx)</Title>
