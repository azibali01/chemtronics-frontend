...
export default function SalesInvoicePage() {
  ...
  const fetchSalesInvoices = async () => {
    try {
      const response = await axios.get(
        "https://chemtronics-backend-zbf6.onrender.com/sale-invoice"
      );
  ...
  const updateSalesInvoice = async (invoiceData: Invoice) => {
    try {
      ...
      const response = await axios.put(
        `https://chemtronics-backend-zbf6.onrender.com/sale-invoice/${editInvoice?.id}`,
        payload
      );
  ...
  const deleteSalesInvoice = async (invoiceId: number) => {
    try {
      await axios.delete(
        `https://chemtronics-backend-zbf6.onrender.com/sale-invoice/${invoiceId}`
      );
